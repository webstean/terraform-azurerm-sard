...
| [azurerm_dns_a_record.vmss_external_reverse_fqdn](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_a_record) | resource |
...
| [azurerm_dns_cname_record.autodiscover](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_cname_record) | resource |
| [azurerm_dns_cname_record.ingress_frontdoor](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_cname_record) | resource |
...
| [azurerm_dns_cname_record.m365-enterpriseenrollment](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_cname_record) | resource |
| [azurerm_dns_cname_record.m365-enterpriseregistration](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_cname_record) | resource |
| [azurerm_dns_cname_record.mssql_private_relay](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_cname_record) | resource |
| [azurerm_dns_cname_record.nlb](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_cname_record) | resource |
| [azurerm_dns_cname_record.pubsub](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_cname_record) | resource |
| [azurerm_dns_cname_record.storage1](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_cname_record) | resource |
| [azurerm_dns_cname_record.storage2](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_cname_record) | resource |
| [azurerm_dns_cname_record.t4](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_cname_record) | resource |
| [azurerm_dns_cname_record.t6](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_cname_record) | resource |
| [azurerm_dns_cname_record.test](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_cname_record) | resource |
| [azurerm_dns_cname_record.vmss](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_cname_record) | resource |
| [azurerm_dns_cname_record.web](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_cname_record) | resource |
| [azurerm_dns_mx_record.mail](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_mx_record) | resource |
| [azurerm_dns_ns_record.aca](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/dns_ns_record) | resource |
...
| [azurerm_network_security_group.any2any](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/network_security_group) | resource |
...
| [azurerm_role_assignment.diag_storage_table_full_access](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/role_assignment) | resource |
...
| [azurerm_role_assignment.this_storage_blob_full_access](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/role_assignment) | resource |
| [azurerm_role_assignment.this_storage_queue_full_access](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/role_assignment) | resource |
| [azurerm_role_assignment.this_storage_table_full_access](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/role_assignment) | resource |
...
| [random_integer.random_region_zone](https://registry.terraform.io/providers/hashicorp/random/latest/docs/resources/integer) | resource |
...
| [random_string.cog_random_suffix](https://registry.terraform.io/providers/hashicorp/random/latest/docs/resources/string) | resource |
...
| <a name="input_ai_free_search_id"></a> [ai\_free\_search\_id](#input\_ai\_free\_search\_id) | The ID of the AI Free Search resource to be used. | `string` | `null` | no |
| <a name="input_ai_free_search_principal_id"></a> [ai\_free\_search\_principal\_id](#input\_ai\_free\_search\_principal\_id) | The principal ID of the AI Free Search resource to be used. | `string` | `null` | no |
...
| <a name="input_container_registry_login_server"></a> [container\_registry\_login\_server](#input\_container\_registry\_login\_server) | The login server of the Azure Container Registry to be used. | `string` | `null` | no |
| <a name="input_container_registry_name"></a> [container\_registry\_name](#input\_container\_registry\_name) | The name of the Azure Container Registry to be used. | `string` | `null` | no |
...
| <a name="input_private_link_service_port"></a> [private\_link\_service\_port](#input\_private\_link\_service\_port) | The port on which the Private Link Service will listen. | `number` | `8080` | no |
...
| <a name="input_vmss_autoscale_default_capacity"></a> [vmss\_autoscale\_default\_capacity](#input\_vmss\_autoscale\_default\_capacity) | Virtual Machine Scale Set: default instance count used during normal business hours. | `number` | `2` | no |
...
| <a name="input_vmss_autoscale_max_capacity"></a> [vmss\_autoscale\_max\_capacity](#input\_vmss\_autoscale\_max\_capacity) | Virtual Machine Scale Set: maximum number of instances to scale up to. | `number` | `5` | no |
...
| <a name="input_vmss_autoscale_scale_out_cpu_threshold"></a> [vmss\_autoscale\_scale\_out\_cpu\_threshold](#input\_vmss\_autoscale\_scale\_out\_cpu\_threshold) | Virtual Machine Scale Set: average CPU percentage threshold that triggers a scale-out (add instances). | `number` | `65` | no |
...
| <a name="input_vmss_autoscale_time_grain"></a> [vmss\_autoscale\_time\_grain](#input\_vmss\_autoscale\_time\_grain) | Virtual Machine Scale Set: granularity/frequency of metric data points collected in ISO 8601 format (e.g., PT1M for 1 minute intervals). | `string` | `"PT2M"` | no |
...
| <a name="input_vmss_port_tcp_internal_probe"></a> [vmss\_port\_tcp\_internal\_probe](#input\_vmss\_port\_tcp\_internal\_probe) | The port on which the internal service's probe will listen. | `number` | `80` | no |
...
| <a name="output_pls_private_ip"></a> [pls\_private\_ip](#output\_pls\_private\_ip) | The private IP address of the Private Link Service |
| <a name="output_pls_public_ip"></a> [pls\_public\_ip](#output\_pls\_public\_ip) | The Public IP address of the Private Link Service. Since the Private Link Service should not be public, this should be 0.0.0.0. |
