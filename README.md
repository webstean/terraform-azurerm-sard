...
| <a name="input_ai_free_search_id"></a> [ai\_free\_search\_id](#input\_ai\_free\_search\_id) | The ID of the Azure AI Search service to be used. | `string` | `null` | no |
| <a name="input_ai_free_search_principal_id"></a> [ai\_free\_search\_principal\_id](#input\_ai\_free\_search\_principal\_id) | The principal ID of the Azure AI Search service to be used. | `string` | `null` | no |
