...
| <a name="input_private_link_service_port"></a> [private\_link\_service\_port](#input\_private\_link\_service\_port) | The port on which the Private Link Service will listen. | `number` | `80` | no |
