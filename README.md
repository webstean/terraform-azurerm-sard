...
| <a name="input_aca_enable_dapr"></a> [aca\_enable\_dapr](#input\_aca\_enable\_dapr) | description = <<DESC<br/>If true, enables Dapr for the Azure Container Apps environment. If false, does not enable Dapr. | `bool` | `false` | no |
...
| <a name="input_deploy_ai_embeddings"></a> [deploy\_ai\_embeddings](#input\_deploy\_ai\_embeddings) | description = <<DESC<br/>If true, deploys AI embeddings for the environment. If false, does not deploy AI embeddings. | `bool` | `false` | no |
