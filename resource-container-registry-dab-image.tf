...
locals {
  dab_image_repository = "${module.containerregistry.login_server}/dab-broker"
...
FROM $${BASE_IMAGE}
ENV DATABASE_CONNECTION_STRING=${local.local.sql_database_connection_free_encrypted}
