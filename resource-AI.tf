locals {
  ...
  cog_random_suffix = substr(random_string.environment.result, 0, 6)
  cog_name_hostname = lower(substr(replace("c${local.cog_random_suffix}${var.prefix}${local.cog_name_location}", "-", ""), 0, 24))
